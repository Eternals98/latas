  ...
  <aside className="w-64 flex-shrink-0 bg-paper-50 border-r border-slate-200 flex flex-col">
    ...
    <div className="p-6 pb-5 border-b border-slate-200">
      <div className="flex items-center gap-3">
        <div className="w-10.5 h-10.5 rounded-xl bg-ink-900 grid place-items-center shadow-2 p-2">
    ...
    <div className="p-4 pb-2">
      <div
        ...
        className={cn(
          "flex items-center gap-3 p-3 rounded-xl border transition-all cursor-pointer hover:shadow-1",
