    ...
    <div className="p-8 max-w-[1200px] mx-auto animate-in fade-in duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col gap-6">
          <div className="text-[11px] tracking-widest uppercase font-semibold text-slate-500">Reportes Disponibles</div>
        ...
        <div className="flex flex-col gap-6">
          <div className="text-[11px] tracking-widest uppercase font-semibold text-slate-500">Vista Previa</div>
          <Card padding={0} className="bg-white min-h-[500px] shadow-3 relative overflow-hidden border border-slate-200">
            {/* Ledger paper effect */}
            ...
            <div className="p-10 md:p-15">
              ...
              <div className="mt-15 flex justify-end">
                <div className="text-right border-t border-ink-900 pt-3 w-[200px]">
                  <div className="text-[9px] tracking-widest uppercase font-bold text-slate-500">Total General</div>
...
const ReportItem = ({ title, desc, icon, active }: { title: string, desc: string, icon: string, active?: boolean }) => (
  <div className={cn(
    "flex gap-4 p-5 rounded-xl border transition-all cursor-pointer hover:shadow-1",
    active ? "bg-paper-50 border-brass-400" : "bg-white border-slate-200"
  )}>
    <div className={cn(
      "w-11 h-11 rounded-lg grid place-items-center transition-colors flex-shrink-0",
